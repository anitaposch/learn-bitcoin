...
Eine Bitcoin-On-Chain-Transaktion kann nicht einfach mit einer VISA-Zahlung verglichen werden. Im traditionellen Bankwesen gibt es verschiedene Abwicklungsebenen, d.h. sie unterscheiden sich in ihrem Sicherheits- und Abwicklungsniveau. Nehmen wir als Beispiel das US-System für VISA-Zahlungen, das vergleichbar ist mit anderen weltweit existierenden Systemen zur Abwicklung von VISA-Zahlungen. Die Basisebene sind die Fedwire-, CHIPS- und SWIFT-Netzwerke, während Debit- und Kreditkartenzahlungen eine oder zwei Ebenen darüber mit vielen Zwischenhändlern abgewickelt werden. Die Basisschicht von Bitcoin muss mit Fedwire, CHIPS und SWIFT verglichen werden. Nur Lösungen auf der zweiten Ebene wie schnelle Mikrozahlungen über das Lightning-Netzwerk können mit VISA verglichen werden.
