...
Dieses Beispiel ist bedeutend, weil es eine natürlich entstandene Nutzung eines gemeinsamen Kontobuches demonstriert. Das Wissen über den Eigentumsstand wurde unter den dort Lebenden ausschließlich mündlich weitergegeben, ohne einen einzigen Stein zu bewegen. Alle waren sich einig, wem welcher Stein gehört und jede einzelne Person konnte dies kontrollieren. Ein Konsens wurde gefunden. Genauso können Sie sich die Funktion der Bitcoin-Blockchain vorstellen. Es ist ein öffentliches Kontobuch aller Transaktionen, die gleichzeitig und synchron auf tausenden Computern (Knoten/Nodes) weltweit gespeichert sind. [^4]
